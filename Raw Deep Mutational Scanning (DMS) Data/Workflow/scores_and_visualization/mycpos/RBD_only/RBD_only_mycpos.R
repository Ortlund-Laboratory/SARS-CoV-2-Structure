...
escape_counts <- read_tsv("/home/adkeith@Eu.Emory.Edu/DMS_Workflow/nucleocapsid/R_N-05_Myc_Mar_2022_version_to_use_for_paper/exp2_mycpos/RBD_only/sp_nwt_escape.txt")
input_counts <- read_tsv("/home/adkeith@Eu.Emory.Edu/DMS_Workflow/nucleocapsid/R_N-05_Myc_Mar_2022_version_to_use_for_paper/exp2_mycpos/RBD_only/sp_nwt_input.txt")
...
aa_order <- c(posative,positive, polar, nonpolar, aromatic)
